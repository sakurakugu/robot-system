...
2. 服务器地址改成 ssh ubuntu@106.53.174.61

3. 写机器狗教学内容

4. 群控、编舞，然后是ai优化、物品识别并走过去（能用但都一般般），然后人脸识别还没搞

5. 向后走 步数 是 -2 并没有向后走，而是向前走

6. 手机端和前端如果关闭了对话页面，之前的聊天记录不会储存

7. 改一下动作的提示词

8. https://grpc.org.cn/docs/what-is-grpc/introduction/
...
12. 实现 `last_action_before_disable` 功能
