...
check_project_deps() {
    ...
    check_npm_packages "$PROJECT_ROOT/app/robot-cloud/后端" "后端 - Robot Chat"
    check_npm_packages "$PROJECT_ROOT/app/robot-cloud/前端" "前端 - Robot Chat"
...
check_project_files() {
    ...
    check_path "$PROJECT_ROOT/app/robot-cloud/后端/src/server.ts" "机器人聊天后端入口文件" true
    check_path "$PROJECT_ROOT/app/robot-cloud/前端/src/main.ts" "机器人聊天前端入口文件" true
